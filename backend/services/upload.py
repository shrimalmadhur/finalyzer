...
from backend.parsers.chase_report_pdf import parse_chase_report_pdf, is_chase_spending_report
from backend.parsers.amex_csv import parse_amex_csv
from backend.parsers.amex_year_end_pdf import parse_amex_year_end_pdf, is_amex_year_end_summary
...
async def _background_processing(transactions: list[Transaction], file_hash: str) -> None:
    ...
    try:
        ...
        if uncategorized_ids:
            ...
            print(f"Background: LLM categorization complete")
        ...
        if untagged_ids:
            ...
            print(f"Background: LLM tagging complete")
        ...
        print(f"Background: Vector store update complete")
