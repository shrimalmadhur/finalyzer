...
class TestCalculateStats:
    ...
    def test_stats_source_breakdown(self):
        ...
        transactions = [
            make_transaction("CHASE TXN", -50.0, date(2024, 5, 1), 
                           source=TransactionSource.CHASE_CREDIT),
            make_transaction("AMEX TXN", -75.0, date(2024, 5, 1), 
...
class TestSubscriptionQueries:
    ...
    def test_netflix_specific_search(self):
        ...
        filtered = [
            txn for txn in transactions 
            if "netflix" in txn.description.lower()
        ]
...
class TestBrandVsCategoryQueries:
    ...
    def test_brand_query_uses_direct_search(self):
        ...
        from backend.services.query_engine import _extract_brand_keywords
    ...
    def test_airline_query_filters_non_airlines(self):
        ...
        for txn in airline_txns:
            assert _has_required_tags(txn, required_tags) is True, \
                f"Airline transaction should pass: {txn.description}"
