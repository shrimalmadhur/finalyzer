...
def _parse_page_transactions(text: str, year: int, file_hash: str, seen_hashes: set[str]) -> list[Transaction]:
...
def _parse_table_transactions(
    table: list[list[str | None]], year: int, file_hash: str, seen_hashes: set[str]
) -> list[Transaction]:
